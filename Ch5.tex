...
\begin{enumerate}
	...
	\item [(d)]
		...
		\centering
		\includegraphics[width=4cm]{5.6_picture/lamb0.1-iter10000.png}
		%\caption{fig1}
		\end{minipage}%
		}%
		...
		\begin{minipage}[t]{0.25\linewidth}
		\centering
		\includegraphics[width=4cm]{5.6_picture/lamb0.2-iter10000.png}
		%\caption{fig2}
		\end{minipage}%
		}%
		...
		\begin{minipage}[t]{0.25\linewidth}
		\centering
		\includegraphics[width=4cm]{5.6_picture/lamb0.3-iter10000.png}
		%\caption{fig2}
		\end{minipage}%
		}%
		...
		\begin{minipage}[t]{0.25\linewidth}
		\centering
		\includegraphics[width=4cm]{5.6_picture/lamb0.4-iter10000.png}
		%\caption{fig2}
		\end{minipage}
		}%
		...
		\begin{minipage}[t]{0.25\linewidth}
		\centering
		\includegraphics[width=4cm]{5.6_picture/lamb0.5-iter10000.png}
		%\caption{fig2}
		\end{minipage}
		}%
		...
		\begin{minipage}[t]{0.25\linewidth}
		\centering
		\includegraphics[width=4cm]{5.6_picture/lamb0.6-iter10000.png}
		%\caption{fig2}
		\end{minipage}%
		}%
		...
		\begin{minipage}[t]{0.25\linewidth}
		\centering
		\includegraphics[width=4cm]{5.6_picture/lamb0.7-iter10000.png}
		%\caption{fig2}
		\end{minipage}%
		}%
		...
		\begin{minipage}[t]{0.25\linewidth}
		\centering
		\includegraphics[width=4cm]{5.6_picture/lamb0.8-iter10000.png}
		%\caption{fig2}
		\end{minipage}%
		}%
		...
		\begin{minipage}[t]{0.25\linewidth}
		\centering
		\includegraphics[width=4cm]{5.6_picture/lamb0.9-iter10000.png}
		%\caption{fig2}
		\end{minipage}%
		}%
